...
Route::middleware(['auth'])->prefix("admin/")->group(function () {
  Route::controller(DashboardController::class)->group(function () {
    ...
    Route::match(['get', 'post'], 'readAllMessage', "readAllMessage")->name("read-all-message");
  });
  ...
  //Project
  Route::middleware(["is_admin"])->controller(ProjectController::class)->group(function () {
  ...
  //Skill
  Route::middleware(["is_admin"])->controller(SkillController::class)->group(function () {
  ...
  //Message
  Route::middleware(["is_admin"])->controller(MessageController::class)->group(function () {
  ...
  //Testimonial
  Route::middleware(["is_admin"])->controller(TestimonialController::class)->group(function () {
  ...
  //Certificate
  Route::middleware(["is_admin"])->controller(CertificateController::class)->group(function () {
  ...
  //Certificate
  Route::middleware(["is_admin"])->controller(CvController::class)->group(function () {
