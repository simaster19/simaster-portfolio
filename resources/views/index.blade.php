    ...
    <div class="row align-items-center" style="height: 250px">
      <div class="col-12 col-md-6">
        ...
        <small class="text-white">If you subscribe, you can get notification from my
          Article.</small>
        <form action="{{route('subscribe_me')}}" method="POST">
          @csrf
...
<img class="img" src="{{ Storage::url('images/post/cover/' . $post->gambar) }}"
...
<a href="https://{{$skill->link}}" target="_blank" class="d-inline">
<img src="{{ Storage::url('images/logo/' . $skill->logo) }}"
title="{{ $skill->nama_skill }}" alt="{{ $skill->nama_skill }}" width="80px"
