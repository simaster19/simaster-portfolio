                    ...
                    <div class="col-lg-6 wow fadeInUp" data-wow-delay="0.1s">
                        ...
                        <div class="d-flex align-items-center mt-4">
                            ...
                            <a class="btn btn-outline-primary btn-square"
                                href="https://www.linkedin.com/in/miftakhulkirom/"><i
                            ...
                            <div class="service-item d-flex flex-column justify-content-center text-center rounded">
                                <div class="service-icon flex-shrink-0">
                                    <img class="img img-thumbnail"
                                        src="{{ Storage::url('images/post/cover/' . $post->gambar) }}" alt="" />
                                </div>
            ...
            <div class="container px-lg-5">
                ...
                <div
                    ...
                    @foreach ($datas['skills'] as $skill)
                        <img src="{{ Storage::url('images/logo/' . $skill->logo) }}" title="{{ $skill->nama_skill }}"
                            alt="{{ $skill->nama_skill }}" width="90px" height="70px" class="image shadow-dark"
                            style="
