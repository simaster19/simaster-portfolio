        ...
        <div class="col-md-3">
          <div class="sidebar">
            ...
            <ul class="list-group category-list">
              ...
              <li class="list-group-item" data-category="lifestyle">Lifestyle</li>
              <li class="list-group-item" data-category="entertainment">Entertainment</li>
              <li class="list-group-item" data-category="health">Health</li>
            </ul>
          </div>
        </div>
        ...
        <div class="col-md-9">
          <div class="d-flex justify-content-between mb-4">
            ...
            <div>
              ...
              <i id="gridViewBtn" class="bi bi-grid-3x3-gap view-toggle btn btn-outline-secondary"></i>
            </div>
          </div>
          ...
          <div id="articleContainer" class="d-flex flex-wrap list-view">
            ...
            <div class="article">
              <img src="{{ $article->gambar }}" alt="Article Image">
              <div class="article-body">
                ...
                <div class="article-meta">
                  ...
                  <span class="text-muted">Published on: {{ $article->created_at }}</span>
                </div>
              </div>
            </div>
            @endforeach
...
@push("js-custom")
<script>
// Logika AJAX tetap sama untuk filter kategori
function loadArticles(category) {
$.ajax({
url: '/get-article', // Sesuaikan dengan URL endpoint Anda
method: 'GET',
...
<p>${article.summary}</p>
<div class="article-meta">
<span class="badge bg-primary article-category">${article.category}</span>
<span class="text-muted">Published on: ${article.created_at}</span>
</div>
</div>
</div>
