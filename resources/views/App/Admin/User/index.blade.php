          ...
          <table class="table table-striped" id="table-1">
            ...
            <tbody>
              ...
              <tr>
                ...
                <td>
                  <button type="submit" class="btn btn-primary btn-round"><i class="fas fa-edit"></i></button>
                  <button type="submit" class="btn btn-warning btn-round"><i class="fas fa-eye"></i></button>
