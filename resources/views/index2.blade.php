      ...
      <div class="row align-items-center">
        ...
        <div class="col-lg-7 text-center text-lg-left">
          ...
          <div class="d-flex align-items-center justify-content-center justify-content-lg-start pt-5">
            <a href="{{ is_null($datas['cv']) ? '' : Storage::url('files/cv/' . $datas['cv']->file_cv) }}"
              class="btn btn-outline-light" download>Download
              CV</a>
      ...
      <div class="row align-items-center">
        ...
        <div class="col-lg-7">
          ...
          <div class="row mb-3">
            ...
            <div class="col-sm-6 py-2">
              <h6>Freelance: <span class="text-primary">Available</span></h6>
            </div>
          </div>
    ...
    <div class="container">
      ...
      <div class="row pb-3">
        ...
        <div class="col-lg-4 col-md-6 text-center mb-5">
          ...
          <p>
            Our Open API documentation services offer comprehensive solutions for documenting your APIs,
  ...
  <div class="container-fluid pt-5 pb-3" id="portfolio">
    <div class="container">
      ...
      <div class="row portfolio-container">
        ...
        @foreach ($datas['projects'] as $project)
        <div
          class="col-lg-4 col-md-6 mb-4 portfolio-item {{ $project->jenis_project == 'WEB' ? 'first' : ($project->jenis_project == 'DESKTOP' ? 'second' : 'third') }}">
            ...
            <div class="portfolio-btn bg-primary d-flex align-items-center justify-content-center">
              <a href="{{ Storage::url('images/cover/' . $project->cover) }}"
                ...
                <p class="text-white" style="font-size: 20px; ">
                  {{ $project->status }} | {{ $project->jenis_project }}
                </p>
              </a>
            </div>
            @endif
